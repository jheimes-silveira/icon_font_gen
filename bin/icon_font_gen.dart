...
import 'package:icon_font_gen/generate_flutter_class.dart';
import 'package:icon_font_gen/templates/npm_package.dart';
import 'package:icon_font_gen/utils.dart';
import 'package:path/path.dart' as path;

void main(List<String> args) async {
  final runner = CommandRunner('icon_font_gen', 'Generate you own fonts')
